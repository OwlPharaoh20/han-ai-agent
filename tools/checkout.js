            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, stripe.checkout.sessions.create({
                            ...
                            mode: 'payment',
                            line_items: cartItems.map(function (item) { return ({
                                price_data: {
                                    currency: 'usd',
                                    product_data: {
                                        name: item.name,
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('❌ Stripe Checkout Error:', error_1.message);
                    return [2 /*return*/, "\u274C Failed to create checkout session: ".concat(error_1.message)];
